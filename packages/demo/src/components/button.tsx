      ...
      <Grid xsCol="12">
        ...
        <Card xsCol="12">
          ...
          <p>
            ...
            LinkButton use the component <code>LinkButton</code>. To add a
            Social button use the component <code>GithubButton</code>,{" "}
        ...
        <Card xsCol="12">
          ...
          <FlexRow>
            ...
            <Button glow background="success">Success</Button>
            <Button glow background="info">Info</Button>
            <Button glow background="danger">Danger</Button>
            <Button glow background="warning">Warning</Button>
            <Button glow background="dark">Dark</Button>
          </FlexRow>
        </Card>
        <Card xsCol="12">
          <h5>Gradient</h5>
        ...
        <Card xsCol="12">
          <h5>Outline</h5>
          <p>
            To change the button style to an outline, set the{" "}
            <code>outline</code> prop to true
          </p>
          <FlexRow>
        ...
        <Card xsCol="12">
          <h5>Icon Right</h5>
          <p>
            To move icon to the the right set <code>iconRight</code> prop to
            true
          </p>
          <FlexRow>
        ...
        <Card xsCol="12">
          <h5>Icon Only</h5>
          <p>
            To show only icon in the button set <code>iconOnly</code> prop to
            true
          </p>
          <FlexRow>
